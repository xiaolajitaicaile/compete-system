...
<script>
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            ...
            //在此处field 的name isbn typeId 在 下mapeper的xml文件的property属性对应
            cols: [[
                {type: "checkbox", width: 50},
                //{field: 'id', width: 100, title: 'ID', sort: true},
                {field: 'isbn', width: 100, title: '竞赛编号'},
                {field: 'name', width: 100, title: '竞赛名称'},
                {field:'typeId', width: 100, title: '竞赛类型id'},
                {templet:'<div>{{d.typeInfo.name}}</div>',width:100,title:'竞赛类型'},
                {field: 'author', width: 80, title: '带队老师'},
                // {field: 'price', width: 80, title: 'XXX'},
                // {field: 'language', width: 80, title: 'XXX'},
